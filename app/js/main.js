...
const imgButton = document.getElementById('img-btn');// bagian ini digunakan untuk memanggil element id yaitu img-btn kemudian ditambahkan eventlistener dengan cara klik pada colom fetchdata
...
const textButton = document.getElementById('text-btn');// bagian ini digunakan untuk memanggil element id yaitu img-btn kemudian ditambahkan eventlistener dengan cara klik pada colom fetchdata
